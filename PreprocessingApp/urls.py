...
from .views import UploadCSVView, LaunchProcessingView, MyCSVListView, CSVStatusView,CSVMetricasView,CSVImagesView
...
urlpatterns = [
    ...
    path('imagenes/<int:csv_id>/', CSVImagesView.as_view(), name='csv-imagenes'),
]